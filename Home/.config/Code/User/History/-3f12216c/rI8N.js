...
electron.app.whenReady().then(() => {
	...
	electron.ipcMain.handle("components:get", () => projects.getAllObjectsOfType(".comp.ts"));
	electron.ipcMain.handle("components:get:name", () => projects.getAllNames(".comp.ts"));
	electron.ipcMain.handle("components:add", projects.addComponent);

	electron.ipcMain.on("assets:openfile", projects.openFile);
	electron.ipcMain.handle("selection:get", projects.getSelection)
