...
document.getElementById("newsystem").addEventListener("click", (e) => {
	window.electronAPI.writeFile("Assets" + cwd + "/SysName.sys", "function SysName {\n\t\n}");
	render();
});