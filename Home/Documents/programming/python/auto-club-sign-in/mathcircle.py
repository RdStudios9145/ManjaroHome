...
def Run(name):
    ...
    inc.run(name,
        ...
        "/html/body/div/div[2]/form/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div[65]/span",
        "/html/body/div/div[2]/form/div[2]/div/div[3]/div[1]/div[1]/div/span/span")

Run("Holden Seidel")
Run("Tom Scheib")
inc.finish()
subprocess.run(["curl", "-d", "Successfully logged into math circle",
"https://ntfy-naspi.rdstudios.org/clubs-sign-in"])
